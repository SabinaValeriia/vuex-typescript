...
.container
    .hotel__card
        .hotel__card_content
            ...
            .hotel__card_block
                p.hotel__card_title {{hotel_item_data.name}}
                p.hotel__card_text {{hotel_item_data.desc}}
                .hotel__card_box 
...
.hotel__card{
    ...
    &_box{
        ...
        &_button{
        &-first{
            background: linear-gradient(90deg, #FAF46F -38.31%, #FF7000 202.45%);
            border-radius: 2px;
            width: max-content;
            height: 22px;
            font-family: "MPLUS1p-Bold";
